...
<%
    ...
    List<User> list = UserDao.getStudents(Class_Name);
...
<div class="container">
    ...
    <div class="right side">
        <h3 class="users-header">მოსწავლეები</h3>
        ...
        <table class="user-table" id="myTable">
            ...
            <tr>
                ...
                <th style="width: 250px;">პირადი ნომერი</th>
            </tr>
            </thead>
            ...
            <c:forEach items="${list}" var="u">
                <tr>
                    ...
                    <td onClick="document.location.href='UserProfileByID.jsp?User_ID=${u.getUser_ID()}';">${u.getID_Number()}</td>
                </tr>
