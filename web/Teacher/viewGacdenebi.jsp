...
<div class="container">
    ...
    <div class="right side">
        ...
        <table style="max-height: 700px;overflow:auto;display: block;margin-top: 40px;" class="table1">
            <thead style="background-color: #3a519d;color: white;">
            <tr style="height: 50px;">
                <th style="width: 20px;">№</th>
                <th style="width: 250px;">კლასი</th>
                <th style="width: 300px;">დღევანდელი მონაცემები</th>
                <th style="width: 300px;">დავალების ნახვა</th>
            </tr>
            </thead>
            ...
            <c:forEach items="${classList}" var="u">
                <tr style="height: 30px;">
                    ...
                    <td><a href="viewGacdenebiTable.jsp?Class_Name=${u.getClass_Name()}&Class_ID=${u.getClass_ID()}" style="color:black">ნახვა</a></td>
                    <td><a href="viewDavalebaTeacher.jsp?Class_Name=${u.getClass_Name()}&Class_ID=${u.getClass_ID()}&Subject_ID=${Subject_ID}" style="color: black">გადასვლა</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
