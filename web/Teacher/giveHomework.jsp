...
<%
    ...
    pageContext.setAttribute("subject", UserDao.getSubject_byObject(obj));
...
<div class="container">
    ...
    <div class="right side">
        ...
        <form class="form1" action="../TeacherProcess/saveHomework.jsp?Class_ID=${Class_ID}&Class_Name=${Class_Name}&Subject=${subject}" method="post">
            <p class="classlbl">კლასი</p>
            <br> <input type="text" class="className" id="className" value="${Class_Name}" readonly> <br>
            <p class="subjlbl">საგანი</p>
            <br> <input type="text" class="Subject" value="${subject}" name="Subject" readonly> <br>
            <p class="giveDate">თარიღი<p/>
            <br> <input type="date" class="dateGiven" name="given" required> <br>
            <p class="vada">ბოლოვადა</p> <br>
            <input type="date" class="deadLine" name="deadline" required>
            <br>
            <p class="davaleba">დავალება</p> <br> <br>
            <textarea class="textarea" name="davalebaTXT" required> </textarea>
            <br>
            <input type="submit" value="შენახვა" class="submit" id="shenaxva">
        </form>
